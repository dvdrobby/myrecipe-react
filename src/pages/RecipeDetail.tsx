        ...
        <>
                ...
                <div className="absolute bottom-0 w-full flex flex-col gap-5 z-20">
                    ...
                    <div className="flex justify-between p-5 pb-[23px] gap-3">
                        <div className="flex flex-col gap-[6px]">
                            <p className="font-semibold text-[#2d9524]">Top {recipe?.category.name}</p>
            ...
            <section id="Details" className="mt-[30px]">
                ...
                <div className="swiper-tabs w-full overflow-hidden mt-3">
                    <div
                        ...
                        role="tablist"
                        data-tabs-active-classes="shadow-[0_10px_20px_0_#2d952480] !bg-[#2d9524]"
                    ...
                    >
                        ...
                        >
                            <SwiperSlide className="!w-fit pb-[26px]">
                                <button
                                    className="flex items-center gap-[10px] py-3 px-4 rounded-full font-semibold !text-white bg-black transition-all duration-300 hover:shadow-[0_10px_20px_0_#2d952480] hover:!bg-[#2d9524]"
                                    id="ingredients-tab"
                                ...
                                <div className="grid grid-cols-2 gap-5">
                                    {
                                        recipe?.recipe_ingredients.map((ingredient) => (
                                            <div key={ingredient.id} className="flex flex-col items-center text-center w-full rounded-[20px] p-[14px] gap-[14px] bg-white shadow-[0_12px_30px_0_#D6D6D680]">
                                                <div className="thumbnail flex shrink-0 w-full aspect-[138.5/100] rounded-[20px] bg-[#D9D9D9] overflow-hidden">
                                                    <img
                                                        src={`${baseUrl}/${ingredient.ingredient.photo}`}
                                                        className="w-full h-full object-cover"
                                                        alt="thumbnails"
                                                    />
                                                </div>
                                                <div className="flex flex-col gap-[2px]">
                                                    <p className="font-semibold">{ingredient.ingredient.name}</p>
                        ...
                        activeTab === 'tutorials' && (
                            ...
                            >
                                ...
                                <div className="list-items-container flex flex-col mt-[26px]">
                                    {
                                        recipe?.tutorials.map((tutorial, number) => (
            ...
            >
                <div className="flex items-center justify-between gap-3">
                    ...
                    <a target="_blank" href={`${baseUrl}/${recipe?.url_file}`} className="py-3 px-5 rounded-full font-semibold text-white text-nowrap transition-all duration-300 shadow-[0_10px_20px_0_#2d952480] bg-[#2d9524]">
                        Download Now
                    </a>
                </div>
            </div>
